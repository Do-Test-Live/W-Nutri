    ...
    <div class="container">
        ...
        <div class="row pb-5 pt-5 second-section">
            <div class="col-lg-6 col-12 part">
                <div class="row">
                    <div class="col-12">
                        <h3 class="card-title px-3 pt-3" style="background-color: #fedacb;">講座_活動</h3>
                    </div>
                </div>
                <div class="side-card">
                    <div class="row">
            ...
            <div class="col-lg-6 col-12 part">
                <div class="row">
                    <div class="col-12">
                        <h3 class="card-title px-3 pt-3" style="background-color: #fedacb;">媒體訪問</h3>
                    </div>
                </div>
                <div class="side-card">
                    <div class="row">
        ...
        <div class="row pb-5">
            <div class="col-12 d-flex align-item-center justify-content-center">
                <a href="media_access.php" class="btn">See More</a>
            </div>
        </div>
    </div>
